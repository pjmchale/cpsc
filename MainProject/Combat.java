...
public class Combat {
	...
	// transition.toFront();
	// }));
	// Timeline clearTransition = new Timeline(new KeyFrame(Duration.seconds(3.7),
	// ae -> {
	...
	// how many units(DEFEND)",
	// backDrop, displayResults);
	// }
	// }
	// };
	// getUnits(attacker.getName() + "(" + (getAttackingCountry().getUnits() - 1) +
	// ")", " how many units(ATTACK)",
	// backDrop, attackerDone);
	//
	// }
	//
	// /**
	// * displays a number on a specific row relative to the field it will be drawn
	// on
	// *
	// * @param rect
	// * the area these elements will be drawn onto
	...
	// }
	// };
	// System.out.println("defending country has " + defendingCountry.getUnits() + "
	// left");
	...
	// pane.getChildren().clear();
	// getUnits("Move " + attackingCountry.getName() + "(" +
	// (attackingCountry.getUnits() - 1) + ")",
	// "To " + defendingCountry.getName(), new Rectangle(0, 0, 960, 600),
	// moveUnitAction);
	// }
	// });
	//
	...
	// });
	// }
	// nextBtn.addEventHandler(MouseEvent.MOUSE_ENTERED, new
	...
	// }
	// });
	// nextBtn.addEventHandler(MouseEvent.MOUSE_EXITED, new
	// EventHandler<MouseEvent>() {
	// @Override
	// public void handle(MouseEvent e) {
	...
	// * the font color
	// */
	// public void displayResultBox(double x, double y, boolean leftSide, String
	// name, Color color) {
	// Image panelImage;
	...
	// */
	// public void getUnits(String title, String msg, Rectangle field, CallAction
	// ca) {
	...
	// message.relocate(field.getX() + (field.getWidth() - (fontSize / 1.7 *
	// totalChar)) / 2, field.getY());
	// return message;
	// }
	//
	// /**
